...
class MainAuto : SequentialCommandGroup() {
    init {
        addCommands(
            constants.toTouching.deadlineWith(LiftSetHeight(constants.liftBottomHeight, false)),
            OuttakeTubes(1).deadlineWith(LiftSetHeight(constants.liftBottomHeight, false)),
            constants.fromTouching.deadlineWith(LiftSetHeight(constants.liftBottomHeight, false)),
